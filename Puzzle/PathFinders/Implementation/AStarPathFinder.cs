    ...
    public class AStarPathFinder : IPathFinder
    {
        ...
        public int[] SearchPath(int[] input, GameField gameField)
        {
            ...
            while (openSet.Count > 0)
            {
                ...
                if (isTerminalSiquance(currentNode.CellsStateMap))
                {
        ...
        private List<PathNode> GetNextLevelNodes(PathNode currentNode)
        {
            ...
            foreach (var moveCellIndex in availableMoves)
            {
                ...
                nextLevelNode.Add(new PathNode()
                {
                    ...
                    TotalDistanceForCompletion = GetDistanceForCompletion(cellStateMap),
        ...
        private int GetDistanceForCompletion(List<CellState> map)
        {
            int totalLength = 0;
        ...
        private bool isTerminalSiquance(List<CellState> cellsStateMap)
        {
            return GetDistanceForCompletion(cellsStateMap) == 0;
        }
    }
}
